...
RUN curl -L -o uncrustify-0.79.0.tar.gz https://github.com/uncrustify/uncrustify/archive/uncrustify-0.79.0.tar.gz
RUN tar -xzf uncrustify-0.70.1.tar.gz
WORKDIR /uncrustify-uncrustify-0.79.0
RUN mkdir build
WORKDIR /uncrustify-uncrustify-0.79.0/build
RUN cmake ..
RUN cmake --build .
